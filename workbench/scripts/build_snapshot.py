...
workbench's `Record` shape (see agents/r3/fairsharing/records.py) and written one per line, with
...
Usage: uv run python scripts/build_snapshot.py [--ids PATH] [--out PATH]
"""
...
from workbench.agents.r3.fairsharing.records import PUBLIC_RECORD_URL, Record, from_public_json
