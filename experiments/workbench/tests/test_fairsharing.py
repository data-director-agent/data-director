...
from workbench.agents.r3.fairsharing.snapshot import (
    DEFAULT_MANIFEST,
    DEFAULT_SNAPSHOT,
    SnapshotBackend,
)
from workbench.agents.r3.retrieve import Query, RegistryUnavailable
from workbench.contract.models import OutcomeStatus, RecommendationKind
...
def test_r3_over_the_real_snapshot_recommends_for_the_soil_sample(
    ...
    from workbench.contract.models import DatasetProfile
